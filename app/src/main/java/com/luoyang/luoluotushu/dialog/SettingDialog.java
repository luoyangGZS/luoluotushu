package com.luoyang.luoluotushu.dialog;
...
import com.luoyang.luoluotushu.Config;
import com.luoyang.luoluotushu.R;
import com.luoyang.luoluotushu.util.DisplayUtils;
import com.luoyang.luoluotushu.view.CircleImageView;
...
public class SettingDialog extends Dialog {
    ...
    @BindView(R.id.tv_hkshaonv)
    TextView tv_Hkshaonv;
    @BindView(R.id.tv_hwzhongsong)
    TextView tv_Hwzhongsong;
    @BindView(R.id.tv_kaiti)
    TextView tv_Kaiti;
    @BindView(R.id.tv_youyuan)
    TextView tv_Youyuan;
    ...
    @OnClick({R.id.tv_dark, R.id.tv_bright, R.id.tv_xitong, R.id.tv_subtract, R.id.tv_add, R.id.tv_size_default, R.id.tv_qihei, R.id.tv_fzkatong, R.id.tv_bysong,
